...
export default function VideoThumbnail() {
    ...
    return (<>
        ...
        <div className=" w-full py-10 my-0">
            <div className="flex flex-row gap-6 lg:justify-center sm:justify-start px-0 sm:overflow-x-auto scrollbar-none sm:pl-2">
                {/* First Video */}
                <div className="flex justify-center">
                <iframe className='w-full h-60 sm:h-48 lg:h-60 rounded-lg' src="https://www.youtube.com/embed/Rrw2MGiZmFY" title="Nikitha &amp; Rahi | Wedding Film | 4k | Ankit Studios" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                ...
                <div className="flex justify-center">
                    <iframe
                        className="w-full h-96 sm:h-72 lg:h-96 rounded-lg"
                ...
                <div className="flex justify-center">
                <iframe className='w-full h-60 sm:h-48 lg:h-60 rounded-lg' src="https://www.youtube.com/embed/7cqynucvY6w" title="PRE WEDDING SHOOT IN {VANDRI LAKE} | 4K | Shubham &amp; Sejal | ANKIT STUDIOS" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

                </div>
                <div className="flex justify-center ">
                <iframe className='w-full h-96 sm:h-72 lg:h-96 rounded-lg' src="https://www.youtube.com/embed/mBA8oUJd6iE" title="Akhilesh &amp; Sakshi | Pre Wedding teaser | Pune | 4K | Ankit Studios" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </div>
            <div className='flex justify-center items-center h-full my-4'>
    <div className='text-xl font-serif text-red-500'>
        <span>
            <a href="https://www.youtube.com/@AnkitStudios/featured">AnkitStudios</a>
        </span>
    </div>
</div>
        </div>  
